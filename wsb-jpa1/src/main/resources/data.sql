...
INSERT INTO PATIENT (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, is_insured, address_id) VALUES
    (1, 'John', 'Doe', '1234567890', 'john.doe@example.com', 'P001', '1980-01-01', 0, 1),
    (2, 'Jane', 'Smith', '0987654321', 'jane.smith@example.com', 'P002', '1990-02-02', 1, 2);
...
INSERT INTO DOCTOR (id, first_name, last_name, telephone_number, email, doctor_number, specialization, address_id) VALUES
    ...
    (2, 'Bob', 'Johnson', '5556667777', 'bob.johnson@example.com', 'D002', 'GP', 4);
...
INSERT INTO VISIT (id, description, time, patient_id, doctor_id) VALUES
    ...
    (3, 'Trauma visit', '2024-12-05T11:00:00', 2, 2);

INSERT INTO MEDICAL_TREATMENT (id, description, type, visit_id) VALUES
    (1, 'Abdomen imaging', 'USG', 1),
    (2, 'Cardiac monitoring', 'EKG', 2),
    (3, 'Extremity imaging', 'RTG', 2),
    (4, 'Extremity imaging', 'RTG', 3);
